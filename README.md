[![Build Status](https://travis-ci.org/StevenAD62/js-training.svg?branch=master)](https://travis-ci.org/StevenAD62/js-training)
## Setup
First, [**fork**](https://github.com/StevenAD62/js-training/fork?fragment=1) this repository.
